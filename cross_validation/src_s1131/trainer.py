...
def parse_args():
    ...
    parser.add_argument("--model_locate", type=str)
...
def main():
    ...
    for fold, (train_index, test_index) in enumerate(generator):
        ...
        ckpt_name = f"{model_name}_{data_name }-fold-{fold}-{monitor}_lr-{args.lr}_loss-{args.loss}_index.ckpt"
